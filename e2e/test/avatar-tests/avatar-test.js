...
describe('FEF avatars tests', () => {
  ...
  it('should check avatar ' + UPLOAD_FILE, () => {
    ...
    assert(takeScreenShotOfElementAndCompareWithRef(FIRST_AVATAR_SELECTOR, {localTolerance: 19.9, firefoxTolerance: 7, defaultTolerance: 2, ignoreComparison: false}),
